    ...
    var _copyCsi = function (csi) {
        ...
        // ************************
            modalDefaults = {
                ...
                keyboard: true,
                modalFade: true,
                templateUrl: '/app/views/intCsiCopyModal.html'
            },
            modalOptions = {
    ...
    var _addCsi = function (csi) {
        ...
        // ************************
            modalDefaults = {
                ...
                keyboard: true,
                modalFade: true,
                templateUrl: '/app/views/intCsiInsertModal.html'
            },
            modalOptions = {
                closeButtonText: 'Cancel',
       ...
       var updateCsi = {
        ...
        var csiToUpd = csi.Id + ' ' + csi.Engagement,
            ...
            modalDefaults = {
                ...
                keyboard: true,
                modalFade: true,
                templateUrl: '/app/views/intCsiUpdateModal.html'
            },
            modalOptions = {
                closeButtonText: 'Cancel',
    ...
    var _deleteCsi = function (csi) {
        ...
        // ************************
            modalDefaults = {
                ...
                keyboard: true,
                modalFade: true,
                templateUrl: '/app/views/intCsiDeleteModal.html'
            },
            modalOptions = {
                closeButtonText: 'Cancel',
